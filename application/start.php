...
Autoloader::map(array(
    ...
    'Base_Admin_Controller' => path('app').'controllers/base_admin.php',
    'Base_Teacher_Controller' => path('app').'controllers/base_teacher.php',
    'Base_Student_Controller' => path('app').'controllers/base_student.php',
));
